export const RenderWithVtShader = {
  ...
  fragmentShader: [
    ...
    //  "gl_FragColor = vt_texture(vt, vUv); return;",
      ...
      "  case 2 : gl_FragColor = vt_texture(vt, uv, page); break;",
      "  case 3 : gl_FragColor = vt_textureGrad(vt, uv, vec2(0.), vec2(0.), page); break;",
      "  case 4 : gl_FragColor = vt_textureLod(vt, uv, 0., page); break;",
      "}",
      ...
      "  case 4 : gl_FragColor = textureLod(vt.texture, uv, 0.); break;",
      "}",
